...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> implements Filterable {
    ...
    List<produk> pets, produkFilter;
    private Context context;
    private RecyclerViewClickListener mListener;
    CustomFilter filter;

    public Adapter(List<produk> pets, Context context, RecyclerViewClickListener listener) {
        this.pets = pets;
        this.produkFilter = pets;
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.mName.setText(pets.get(position).getNamaproduk ());
        holder.mType.setText(pets.get(position).getDeskripsi () + " / "
                + pets.get(position).getRating ());
        holder.mDate.setText(pets.get(position).getTgl ());
    ...
    public Filter getFilter() {
        if (filter==null) {
            filter=new CustomFilter((ArrayList<produk>) produkFilter,this);
