...
public class SessionManager {
    ...
    public static final Integer ID_PETUGAS = Integer.parseInt("idpetugas");
    ...
    public void createLoginSession(List<LoginData> loginData) {
        editor.putBoolean(IS_LOGGED_IN, true);
        editor.putInt(String.valueOf(ID_PETUGAS), (user.getIdpetugas()));
